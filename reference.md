...
> Part of [bitcoin-play](README.md). Bookmark this — most of these you'll reach for from Phase 1 onward, not just at the end.

External resources worth keeping handy throughout the path:
...
- **[Bitcoin Stack Exchange](https://bitcoin.stackexchange.com/)** — high-quality Q&A. When you're stuck on a specific error or edge case, the answer is often already there.
...
For per-phase time estimates, see the [pacing section in the intro](docs/00-intro.md#realistic-pacing).
